...
%-------------------------------------------------
\begin{frame}
  \frametitle{Belo Horizonte}
  \framesubtitle{Where are we located?}
  \begin{center}
    \includegraphics[scale=0.5]{figuras/map_of_brazil.jpg}
  \end{center}
  \center
    {\tiny (Image by Lonely Planet \textcopyright)}
\end{frame}

%-------------------------------------------------
\begin{frame}
  \frametitle{Belo Horizonte}
  \framesubtitle{Serra do Curral}
  \begin{center}
    \includegraphics[scale=0.38]{figuras/bh-foto.jpg}
  \end{center}
  \center
    {\tiny (Image by www.temporadalivre.com \textcopyright)}
\end{frame}
